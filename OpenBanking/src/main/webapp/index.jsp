...
<!--   <link href="/OpenBank ing/resources/css/onlyForMe.css" rel="stylesheet"> -->
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="#"><img src="/OpenBanking/resources/images/J_LOGO.png" alt="homepage" width="60">INVESTMENT BANK</a></h1>
